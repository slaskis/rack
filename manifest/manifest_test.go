...
func TestManifestLoad(t *testing.T) {
	n := &manifest.Manifest{
		...
		Tables: manifest.Tables{
			...
			manifest.Table{
				Name: "bar",
				Indexes: manifest.TableIndexes{
					{Name: "alpha", Hash: "one", Range: "two"},
					{Name: "bravo", Hash: "three", Range: "four"},
				},
			},
		},
	}
	...
	attrs := []string{
		...
		"tables.bar",
		"tables.bar.indexes",
		"tables.bar.indexes.alpha",
		"tables.bar.indexes.bravo",
		"tables.bar.indexes.bravo.hash",
		"tables.bar.indexes.bravo.range",
		"tables.foo",
	}
